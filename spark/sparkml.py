...
if __name__ == '__main__':
    ...
    file_list = os.listdir('../resources/HMP_Dataset')
    ...
    for category in file_list_filtered:
        data_files = os.listdir('../resources/HMP_Dataset/' + category)
        ...
        for data_file in data_files:
            ...
            temp_df = spark.read.option("header", "false").option("delimeter", " ") \
                .csv('../resources/HMP_Dataset/' + category + '/' + data_file, schema=schema)
